...
// describe -> define uma categoria
describe('Transactions routes', () => {
  // para esperar que a aplicação esteja totalmente rodando
  beforeAll(async () => {
    await app.ready()
  })

  // finaliza o server de teste ao final dos testes
  afterAll(async () => {
    await app.close()
  })
  ...
  beforeEach(() => {
    ...
    execSync('npm run knex migrante:latest')
  })
